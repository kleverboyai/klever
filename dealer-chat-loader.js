(async APILoader => {
    ...
    API.insert("page-footer", (elem) => {
        ...
        div.innerHTML = `
            <button id="load-chat-widget" style="position: fixed; bottom: 250px; right: 20px; padding: 15px 20px; background: #D90A0AFF; color: #FFF; border: none; border-radius: 10px; cursor: pointer; z-index: 1000;">
                Ask Us Anything
            </button>
        `;
        API.append(elem, div);
